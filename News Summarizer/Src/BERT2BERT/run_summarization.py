...
def main():
    ...
    # Metric
    metric = load_metric("/content/enc_dec_sum/rouge_custom")
    ...
    def compute_metrics(eval_preds):
        ...
        result = metric.compute(predictions=decoded_preds, references=decoded_labels, use_stemmer=True, language="fa")
