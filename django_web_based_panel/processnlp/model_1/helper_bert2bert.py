...
class Helper:
    def __init__(self, model_name_or_path, do_tr_lowercase=True, source_prefix=None, max_source_length=512,
                 max_target_length=120, num_beams=4, ngram_blocking_size=3, early_stopping=None, use_cuda=False,
                 batch_size=2, language="fa",source_column_name = "input"):
    ...
    def load_model_and_tokenizer(self):
        ...
        if "bert" in model_name_or_path:
            model = EncoderDecoderModel.from_pretrained(model_name_or_path, local_files_only=True)
            # set special tokens
